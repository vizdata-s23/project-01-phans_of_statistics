...
[Link to TidyTuesday repository](https://github.com/rfordatascience/tidytuesday/blob/master/data/2022/2022-05-17/readme.md)

[Link to original pre-cleaned data](https://data.world/datagraver/eurovision-song-contest-scores-1975-2019)

### Codebook

Only variables relevant to our study are shown below.
